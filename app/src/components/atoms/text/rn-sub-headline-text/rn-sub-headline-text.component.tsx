...
import { RNSubHeadlineTextProps } from './rn-sub-headline-text.interface';
import styles from './rn-sub-headline-text.styles';
 ...
 */
const RNSubHeadlineText: React.FC<RNSubHeadlineTextProps> = ({
  testID,
  text,
  regular,
  style,
...
export default RNSubHeadlineText;
